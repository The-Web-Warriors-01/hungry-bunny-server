...
async function mail(restaurant_name, to) {
    // console.log(restaurant_name, to)
...
<head>
  ...
  <title>Welcome to Hungry Bunny As a Restaurant</title><!--[if (mso 16)]>
    <style type="text/css">
          ...
          <table cellspacing="0" cellpadding="0" border="0" align="center"
            ...
            <tr style="border-collapse:collapse">
              <td cellpadding="0" cellspacing="0" border="0" style="padding:0;Margin:0;line-height:1px;min-width:600px"
                height="0"><img
                  src="https://qxewrd.stripocdn.email/content/guids/CABINET_837dc1d79e3a5eca5eb1609bfe9fd374/images/41521605538834349.png"
                            ...
                            <table
                              ...
                              <tr style="border-collapse:collapse">
                                <td align="center"
                                  ...
                                  <img
                                    src="https://qxewrd.stripocdn.email/content/guids/CABINET_653153a22a72e9e20c66c84cf8d06ec5ccb2769c83d9c2afb18ab9a1c9ddc119/images/darklogo.png"
                                    alt
                              ...
                              <tr style="border-collapse:collapse">
                                <td class="es-m-txt-l" bgcolor="#ffffff" align="left"
                                  ...
                                  <p
                                    ...
                                    Hi there we have just confirmed your application for joining as a restaurant in
                                    <span style="color:#FF8C00"><strong>Hungry Bunny</strong></span>&nbsp;&nbsp;now you can access to selling food in our website&nbsp;</p>
                                </td>
                              </tr>
                              <tr style="border-collapse:collapse">
                                <td align="center"
                                  ...
                                  <span class="es-button-border"
                                    style="border-style:solid;border-color:#FFA73B;background:#f97316;border-width:1px;display:inline-block;border-radius:2px;width:auto"><a
                                      href="https://hungry-bunny-web.web.app/" class="es-button" target="_blank"
                                      style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:20px;display:inline-block;background:#f97316;border-radius:2px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center;padding:15px 30px;mso-padding-alt:0;mso-border-alt:10px solid #f97316">
                                      Confirmed You</a></span></td>
                              </tr>
                              <tr style="border-collapse:collapse">
                                <td class="es-m-txt-l" align="left"
                                  ...
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;font-size:18px">
                                    Now sing in with your account and get something awesome form us.&nbsp;&nbsp;</p>
                                </td>
                              </tr>
                              <tr style="border-collapse:collapse">
                                <td class="es-m-txt-l" align="left"
                                  style="padding:0;Margin:0;padding-top:20px;padding-left:30px;padding-right:30px"><span
                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#FFA73B;font-size:18px">${restaurant_name}</></td>
                              </tr>
                              <tr style="border-collapse:collapse">
                                <td class="es-m-txt-l" align="left"
                                  style="padding:0;Margin:0;padding-top:20px;padding-left:30px;padding-right:30px">
                            ...
                            <table
                              ...
                              <tr style="border-collapse:collapse">
                                <td esdev-links-color="#ffa73b" align="center"
                                  style="padding:0;Margin:0;padding-bottom:30px;padding-left:30px;padding-right:30px"><a
